...
public class Vd_Cp_loja_Virt_Controller {
	...
	public ResponseEntity<VendaCompraLojaVirtualDTO> salvarVendaLoja(@RequestBody @Valid VendaCompraLojaVirtual vendaCompraLojaVirtual) throws ExceptionMentoriaJava, UnsupportedEncodingException, MessagingException{
		...
		//aqui ele vai atualizar ou persistir um novo
		vendaCompraLojaVirtual.getEnderecoCobranca().setPessoa(pessoaFisica);
		vendaCompraLojaVirtual.getEnderecoCobranca().setEmpresa(vendaCompraLojaVirtual.getEmpresa());
		Endereco enderecoCobranca = enderecoRepository.save(vendaCompraLojaVirtual.getEnderecoCobranca());
		vendaCompraLojaVirtual.setEnderecoCobranca(enderecoCobranca); //aqui setamos ele novamente para o objeto persistente para evitar problema
		...
		//Aqui escolhemos os dados que queremos retornar uma um
		...
		msgemail.append("Olá, ").append(pessoaFisica.getNome()).append("</br>");//enviando email para o cliente
	...
	public ResponseEntity<List<EmpresaTransporteDTO>> 
		...
		//pega o objeto que vamos passar por parametro, passamos o consultafrete e vamos transformar ele em um json
		//resumindo convertemos o valor que estamos recebendo para um json
