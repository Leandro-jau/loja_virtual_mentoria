...
//Nós recebemos por parametro esse objeto: (ObjetoRelatorioStatusCompra objetoRelatorioStatusCompra)	
public List<ObjetoRelatorioStatusCompra> relatorioStatusVendaLojaVirtual(ObjetoRelatorioStatusCompra objetoRelatorioStatusCompra){
		...
		//BeanPropertyRowMapper o sql vai ser convertido em objeto, cada linha sera convertido
